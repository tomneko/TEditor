...
<hr>
<br/>
TEditor は本田勝彦氏によって制作公開されたDelphi用のEditorコンポーネントです。<br/>
TEditor は本田勝彦氏のご遺族の同意によりオープンソースで公開されました。<br/>
本ソフトウェアはMITライセンスで公開されます。詳細はLICENSEを御覧ください<br/>
<br/>
<hr>
<br/>
以下は TEditor のオリジナルのドキュメント(ver.2.52)です。他のバージョンのオリジナルのドキュメントはそれぞれの doc フォルダ内に格納されています。<br/>
<br/>
<hr>
<br/>
<pre>
