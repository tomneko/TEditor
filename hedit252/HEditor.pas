(*********************************************************************
  ...
  TEditor version 2.52

  start  1998/07/05
  update 2006/04/22

  Copyright (c) 1998,2006 本田勝彦 <katsuhiko.honda@nifty.ne.jp>
  ...
  begin
    ...
    begin
      ...
      if FLeftbar.FVisible and FLeftbar.FShowNumber and
        ...
        // では Sp から画面下端までとする
        InvalidateLeftbar(Sp, FTopRow + FRowCount);
    end;
  end;
end;
  ...
  try
    ...
    try
      ...
      try
        ...
        SetSelIndex(Rs + Source.Count - 1, C);
      finally
        UnderlineEndUpdate;
        CaretEndUpdate;
      end;
